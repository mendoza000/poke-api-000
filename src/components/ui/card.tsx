...
export default function Card(props: Props) {
	...
	return (
		<div className="bg-gradient-to-b from-zinc-800  to-zinc-700 md:min-h-[18rem] rounded-xl px-3 pb-5 shadow-xl relative overflow-hidden flex flex-col items-center group mx-auto">
			<img
        ...
        ${
			...
			<div
				className={`h-[7rem] w-[13rem]  -bottom-20 left-1/2 -translate-x-1/2 absolute blur-3xl group-hover:h-[20rem] duration-200 ${
					query.data?.types[0].type.name === "fire"
						? "bg-red-700/50"
						: query.data?.types[0].type.name === "water"
						? "bg-blue-700/50"
